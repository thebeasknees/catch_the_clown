...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if clown_rect.collidepoint(mouse_x, mouse_y):
                ...
                #Change direction of clown when clicked
    ...
    #Bounce clown off display edges
    ...
    if player_lives == 0:
        ...
        #Pause game until player clicks, then reset the game
